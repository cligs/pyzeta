...
def filter_dtm(dtmfolder, parameterstring, idlists):
    ...
    with open(dtmfile, "r") as infile:
        binary = pd.read_csv(infile, sep="\t", index_col="Unnamed: 0")
        #print("\nbinary\n", binary.head())
    ...
    with open(dtmfile, "r") as infile:
        relative = pd.read_csv(infile, sep="\t", index_col="Unnamed: 0")
        #print("\nrelative\n", relative.head())
    ...
    with open(dtmfile, "r") as infile:
        absolute = pd.read_csv(infile, sep="\t", index_col="Unnamed: 0")
        #print("\nabsolute\n", absolute.head())
...
def get_indicators(binary1, binary2, relative1, relative2):
    ...
    #print("docprops1", docprops1.head())
    #print("docprops2", docprops2.head())
    #print("relfreqs1", relfreqs1.head())
    #print("relfreqs2", relfreqs2.head())
...
def get_meanrelfreqs(dtmfolder, parameterstring):
    dtmfile = dtmfolder + "dtm_"+parameterstring+"_relativefreqs.csv"
    with open(dtmfile, "r") as infile:
        meanrelfreqs = pd.read_csv(infile, sep="\t", index_col="Unnamed: 0")
        #print(meanrelfreqs.head())
